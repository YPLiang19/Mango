...
/**
 Initializes a MagnoFix context with specify a RSA public key, the public key must be 1024 bits and PKCS #8.
 
 @param publicKey  RSA public key
 @return MFContext instance
 */
- (instancetype)initWithRSAPublicKey:(NSString *)publicKey NS_DESIGNATED_INITIALIZER;
